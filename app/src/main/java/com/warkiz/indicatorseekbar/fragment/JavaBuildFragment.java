...
public class JavaBuildFragment extends BaseFragment {
    ...
    protected void initView(View root) {
        ...
        IndicatorSeekBar continuous2TickTexts = IndicatorSeekBar
                ...
                .showTickTexts(true)
                .indicatorColor(getResources().getColor(R.color.color_gray))
                .indicatorTextColor(Color.parseColor("#ffffff"))
                .showIndicatorType(IndicatorType.RECTANGLE)
                .thumbDrawable(getResources().getDrawable(R.drawable.selector_thumb_drawable))
                .thumbSize(18)
                .trackProgressColor(getResources().getColor(R.color.colorAccent))
                .trackProgressSize(4)
                .trackBackgroundColor(getResources().getColor(R.color.color_gray))
        ...
        IndicatorSeekBar discrete_ticks_texts = IndicatorSeekBar
                ...
                .thumbColor(getResources().getColor(R.color.colorAccent))
                .thumbSize(14)//dp
                .trackProgressColor(getResources().getColor(R.color.colorAccent))
